...
class RelayProvider extends ChangeNotifier {
  ...
  Future<void> removeRelay(String url) async {
    UserRelayList? userRelayList = null;//await ndk.userRelayLists.broadcastRemoveNip65Relay(relayUrl: url, specificRelays: myOutboxRelaySet!.urls);
  ...
  Future<void> updateMarker(String url, ReadWriteMarker marker) async {
    ...
    UserRelayList? userRelayList = null;//await ndk.userRelayLists.broadcastUpdateNip65RelayMarker(relayUrl: url, marker: marker);
