...
Contact deserializeContact(IsarReader reader) {
  ...
  object.publicKey = IsarCore.readString(reader, 1);
  object.url = IsarCore.readString(reader, 2);
  object.petname = IsarCore.readString(reader, 3);
  return object;
}
...
extension ContactQueryFilter
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> urlGreaterThanOrEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Contact, Contact, QAfterFilterCondition> urlLessThanOrEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
