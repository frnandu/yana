...
Using a [Prism](https://dergigi.com/2023/03/12/lightning-prisms) address at [prism@yana.do](https://btc.fmar.link/api/v1/invoices?storeId=7yXH2h1LUFXStGM4XPoSUpb43xkMj1riEsrAiYSWAk57&currency=SATS), each sat donation will be split into:
...
<a href="lightning:prism@yana.do">PRISM</a>
